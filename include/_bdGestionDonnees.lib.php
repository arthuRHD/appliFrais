...
function connecterServeurBD() {
    $hote = "localhost"; // On ajoute l'ip du Raspberry où se trouve le serveur MariaDB
    $login = "userGsb";
    $mdp = "secret";
...
function obtenirDetailVisiteur($idCnx, $unId) {
    ...
    $requete = "select id, nom, prenom, typeUtilisateur from utilisateur where id='" . $unId . "'";
...
function obtenirTousLesMois(){
    $req = "select mois from Fichefrais group by mois desc";
    return $req;
}   
function obtenirTousLesVisiteurs(){
    $req = "select nom, prenom from utilisateur where typeUtilisateur = 'V';";
    return $req;
}         
?>
